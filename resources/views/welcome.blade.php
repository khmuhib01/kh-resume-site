        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-left">
                    <h1>Hi, I'm {{ $about_me->sur_name }}</h1>
                    <h2 class="cd-headline clip is-full-width">
                        <span class="cd-words-wrapper">
                            @foreach (explode(', ', $about_me->skill_highlights) as $index => $skill)
                                <b class="{{ $index === 0 ? 'is-visible' : '' }}">{{ $skill }}</b>
                            @endforeach
                        </span>
                    </h2>
                    {{-- <h2 class="cd-headline clip is-full-width">
                        <span class="cd-words-wrapper">
                            @php
                                $skills = explode(', ', $about_me->skill_highlights); // Convert string to array
                            @endphp
        ...
        <nav class="navbar navbar-default navbar-static-top" id="nav">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <!-- Brand -->
                    <a class="navbar-brand page-scroll" href="#page-top"><img src="assets/img/logo.png"
                            alt=""></a>
                    <!-- End Brand -->
                </div>
            ...
            <div class="row">
                @foreach ($services as $service)
                    <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-duration="1s" data-wow-delay=".3s">
                        <h3><span class="number">{{ $loop->iteration }}.</span>{{ $service->service_title }}</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay=".4s">
                        ...
                        <p><u>Hi, there!</u>&nbsp;{{ $about_me->description }}</p>

                        <ul class="info">
                            <li>Date Of Birth : {{ $about_me->date_of_birth }}</li>
                            <li>Country : {{ $about_me->country }}</li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 wow fadeIn" data-wow-duration="1s" data-wow-delay=".4s">
                    ...
                    <p>{{ $about_me->skill_description }}</p>
                </div>
                <div class="col-md-4">
                    <h3>Photoshop</h3>
                    <div class="progress">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="wow fadeIn" data-wow-duration="2s" data-wow-delay=".5s">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vitae sem laoreet,
                                    mattis arcu at, lacinia ligula. Praesent bibendum eros ut nulla adipiscing tempus.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row top-pad">
                <div class="col-md-4">
                    <div class="blog-img-overlay">
                        <a href="#"><img src="assets/img/blog/b_01.jpg" alt=""
                    ...
                    <div class="blog-info">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vitae sem laoreet, mattis arcu
                            at, lacinia praesent bibendum eros tempus.</p>
                    </div>
                    <div class="border-style">
                ...
                <div class="col-md-4">
                    <div class="blog-img-overlay">
                        <a href="#"><img src="assets/img/blog/b_02.jpg" alt=""
                                class="img-responsive center-block"></a>
                    </div>
                    <div class="blog-info">
                        <h3><span class="ti-layout-media-overlay-alt-2 blog-icon"></span>Lorem ipsum sample blog</h3>
                ...
                <div class="col-md-4">
                    <div class="blog-img-overlay">
                        <a href="#"><img src="assets/img/blog/b_03.jpg" alt=""
                                class="img-responsive center-block"></a>
                    </div>
                    <div class="blog-info">
                        <h3><span class="ti-layout-media-overlay-alt-2 blog-icon"></span>Lorem ipsum sample blog</h3>
                    ...
                    <form class="form-horizontal" method="post" action="email.php">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <p class="confirmation send-error"><span class="ti-alert"></span>There is a problem
                                    sending email ...</p>
                                ...
                                <button type="submit" class="btn custom-btn-2 wow fadeInUp" data-wow-duration="1s"
                                    data-wow-delay=".5s">Submit</button>
